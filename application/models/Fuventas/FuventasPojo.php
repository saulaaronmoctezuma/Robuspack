...
<<<<<<< HEAD
        ...
        $this->subtotal_mxn = $subtotal_mxn;
        $this->iva_mxn = $iva_mxn;
...
<<<<<<< HEAD
    ...
    public function getPrecio_mxn() {
        return $this->precio_mxn;
    }

    public function getDescuento_mxn() {
        return $this->descuento_mxn;
    }

    public function getSubtotal_mxn() {
        return $this->subtotal_mxn;
    }

    public function getIva_mxn() {
        return $this->iva_mxn;
    }

    public function getTotal_mxn() {
...
<<<<<<< HEAD
    ...
    public function setPrecio_mxn($precio_mxn) {
        $this->precio_mxn = $precio_mxn;
    }

    public function setDescuento_mxn($descuento_mxn) {
        $this->descuento_mxn = $descuento_mxn;
    }

    public function setSubtotal_mxn($subtotal_mxn) {
        $this->subtotal_mxn = $subtotal_mxn;
    }

    public function setIva_mxn($iva_mxn) {
        $this->iva_mxn = $iva_mxn;
    }

    public function setTotal_mxn($total_mxn) {
        $this->total_mxn = $total_mxn;
    }
