...
function __construct($id_recolecion_datos, $vendedor, $identificador, $nombre_empresa, $estado, $ciudad, $domicilio, $nombre, $cargo, $email, $tel, $nombre2, $cargo2, $email2, $tel2, $comentarios, $first_name) {
