...
class Model_devolucion extends CI_Model {
    ...
    /* get the devolucion data */

    public function getDevolucionData($id = null) {
        if ($id) {
    ...
    public function getDevolucionItemData($order_id = null) {
        if (!$order_id) {
            return false;
        }
    ...
    public function update($id) {
        if ($id) {
            ...
            $this->load->model('model_products');
            $get_order_item = $this->getDevolucionItemData($id);
    ...
    public function countTotalPaidDevolucion() {
