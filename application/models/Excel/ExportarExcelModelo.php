...
<<<<<<< HEAD
                 ...
                 date_format(fecha_ultima_visita, "%Y/%m/%d") fecha_ultima_visita
...
>>>>>>> 3ca633ddf977474f5162ba742b7bbb723f11e606
            ...
            $query = $this->db->select('*')->where('id= ', $dataLevel)->get();
            return $query->result();
        }//condicions que realice la consulta solo si es refacciones
//condicions que realice la consulta solo si es refacciones
        else if ($dataLevel == "is_editor") {
  ...
  // Descargar Excel de Cliente
    ...
    */
      ...
      public function ListaFuventas() {
         ...
         */
        $query = $this->db->query("SELECT ref,cliente,direccion, codigo, tipo_de_prod, rfc, factura, facturapdf, remision, fecha_de_remision , orden_compra, cantidad, pu_usd, subtotal, iva, total_usd, fecha , pedimento, fecha_pedimento, dias_de_credito, fecha_vencimiento, DATE_FORMAT(fecha_de_pago, '%d/%m/%Y') AS fecha_de_pago, status_de_pago, refacturacion, nueva, observaciones, vendedor , DATE_FORMAT(fecha_de_cobro_de_comisiones, '%d/%m/%Y') AS fecha_de_cobro_de_comisiones,tipo_de_cambio ,precio_mxn ,descuento_mxn/100 as descuento_mxn ,subtotal_mxn ,iva_mxn ,total_mxn , fecha_insercion, fecha_modificacion,id from fuventas f;");
        ...
        //condicions que realice la consulta solo si es refacciones
            ...
            /* consulta los datos de excel */
              ...
              $query = $this->db->select('*')
                      ...
                      ->where('censo_maquinaria.cliente_robuspack="No" and censo_maquinaria.id_usuario='.$dataLevel)->
                      order_by('users.first_name', 'asc')->get();
            //$query = $this->db->select('*')->from('cliente_seguimiento')->join('users', 'cliente_seguimiento.id=users.id')->get();
            return $query->result();
            ...
            /* consulta los datos de excel */
                ...
                $query = $this->db->select('*
                ')->from('censo_maquinaria')->join('users', 'censo_maquinaria.id_usuario=users.id')->where('censo_maquinaria.cliente_robuspack="No" and censo_maquinaria.id_usuario='.$dataLevel)->order_by('users.first_name', 'asc')->get();
            //$query = $this->db->select('*')->from('cliente_seguimiento')->join('users', 'cliente_seguimiento.id=users.id')->get();
            return $query->result();
        } else if ($dataLevel == "is_maquinaria_refacciones") {
...
//condicions que realice la consulta solo si es refacciones
            ...
            /* consulta los datos de excel */
              ...
              $query = $this->db->select('*')
                      ->from('censo_maquinaria')
                      ->join('users', 'censo_maquinaria.id_usuario=users.id')
                      ->where('censo_maquinaria.cliente_robuspack="Sí" and censo_maquinaria.id_usuario=12')->
                      order_by('users.first_name', 'asc')->get();
            //$query = $this->db->select('*')->from('cliente_seguimiento')->join('users', 'cliente_seguimiento.id=users.id')->get();
            return $query->result();
     ...
     public function ListaCensoMaquinaria() {
        ...
        if ($dataLevel == "is_admin") {
            ...
            /* $query = $this->db->select(['*'])->from('cliente_seguimiento')->get();
              return $query->result(); */
            /*$query = $this->db->select('*
                ')->from('censo_maquinaria')->join('users', 'censo_maquinaria.id_usuario=users.id')->where//('censo_maquinaria.id_censomaquinaria < 200')->order_by('users.first_name', 'asc')->get();
                ('users.id = 4')->order_by('users.first_name', 'asc')->get();*/
        ...
        //condicions que realice la consulta solo si es refacciones
            ...
            /* consulta los datos de excel */
              ...
              $query = $this->db->select('*')
                      ->from('censo_maquinaria')
                      ->join('users', 'censo_maquinaria.id_usuario=users.id')
                      ->where('censo_maquinaria.id_usuario='.$dataLevel)->
                      order_by('users.first_name', 'asc')->get();
            //$query = $this->db->select('*')->from('cliente_seguimiento')->join('users', 'cliente_seguimiento.id=users.id')->get();
            return $query->result();
            ...
            /* consulta los datos de excel */
                ...
                $query = $this->db->select('*
                ')->from('censo_maquinaria')->join('users', 'censo_maquinaria.id_usuario=users.id')->where('censo_maquinaria.id_usuario='.$dataLevel)->order_by('users.first_name', 'asc')->get();
            //$query = $this->db->select('*')->from('cliente_seguimiento')->join('users', 'cliente_seguimiento.id=users.id')->get();
            return $query->result();
        } else if ($dataLevel == "is_maquinaria_refacciones") {
...
<<<<<<< HEAD
        if ($dataLevel == "is_admin") {
            ...
            //consulta de los datos que va a descargar en excel
            $query = $this->db->select('*')->from('maximo_minimo_r')->get();
            return $query->result();
        }
...
<<<<<<< HEAD
     ...
     public function ListaControlMaquinaria() {
        ...
        if ($dataLevel == "is_admin") {
            //consulta de los datos que va a descargar en excel
            //$query = $this->db->select('*')->from('verificacion')->order_by('verificacion.no_maqui', 'desc')->get();
            /* $query = $this->db->query('SELECT * from Cliente'); */


            $query = $this->db->select('
                no_maqui,modelo, empresa, serie, cliente, cliente_temporal,pedimento, observacion, comentario,

if(pedimentopdf !=  "",CONCAT("https://scrobuspack.com/assets/verificacion/", pedimentopdf) , "")  pedimentopdf,



if(foto !=  "",CONCAT("https://scrobuspack.com/assets/verificacion/", foto) , "")  foto,
num_factura,
               
              if(factura !=  "",CONCAT("https://scrobuspack.com/assets/verificacion/", factura) , "")  factura
                , if(refacciones !=  "",CONCAT("https://scrobuspack.com/assets/verificacion/", refacciones) , "")  refacciones,
                
              if(contrato !=  "",CONCAT("https://scrobuspack.com/assets/verificacion/", contrato) , "")  contrato
                 



                     ')->from('verificacion')->order_by('verificacion.no_maqui', 'asc')->get();
            //$query = $this->db->select('*')->from('cliente_seguimiento')->join('users', 'cliente_seguimiento.id=users.id')->get();
            return $query->result();
        } else if ($dataLevel == "is_editor") {
            $query = $this->db->select('
...
num_factura,
            ...
            //$query = $this->db->select('*')->from('cliente_seguimiento')->join('users', 'cliente_seguimiento.id=users.id')->get();
            return $query->result();
        } else if ($dataLevel == "is_Gerente_VentasBORRAR") {
            $query = $this->db->select('
                no_maqui,modelo, empresa, serie, cliente, cliente_temporal,pedimento, observacion, comentario,
