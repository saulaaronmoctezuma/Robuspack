...
<br><br>
	  ...
	  border="0" > ';
        foreach ($data->result() as $row) {
            $output .= '
                                        ...
                                        <tr>
                                        <th>Cliente :</th>
                                        <th style=" width: 450px;word-wrap: break-word;">' . $row->planta . '</th>
                                         </tr>
                                         <tr>
                                        <th>Modelo:</th><th>' . $row->modelo . '</th></tr>
					<tr>
                                        <th>Maquina:</th><th>' . $row->maquina . '</th></tr>
					<tr><th><b>Fecha:</b></th><th>' . $row->fecha . '</th></tr>
                                 <tr><th><b>OC:</b></th><th>' . $row->oc . '</th></tr>
                                     <tr><th><b>Tipo:</b></th><th>' . $row->tipo . '</th></tr>
                                         <tr><th><b>Mantenimiento:</b></th><th>' . $row->mantenimiento . '</th></tr>
                                             <tr><th><b>Reporto:</b></th><th>Ing.   ' . $row->	first_name.' '. $row->	last_name . '</th></tr>
</table>
	...
	<br><br>	
(Problema reportado, Tiempo de Intervensión, eficiencia a entrega)
            <br><br>
            
<!--<fieldset style="width:100%;height: 100%" >-->
<!--<fieldset>-->
  <legend>Descripción de Actividades Efectuadas</legend>
  <p ALIGN="justify">' . $row->des_acti . '&nbsp; </p>
...
<table border="1">
    ...
    <td style="width:300px;">16.-' . $row->ref_usadas16 . '</td>
    </tr>
    <tr>
    <td>2.-' . $row->ref_usadas2 . '</td>
...
<br>
<b>Refacciones Recomendadas:</b><br><br>
<table border="1">

    <tr >
    <td style="width:300px;">1.-'. $row->ref_recomen1 . '</td>
    <td style="width:300px;">16.-'. $row->ref_recomen16 . '</td>
    </tr>
    <tr>
    <td>2.-'. $row->ref_recomen2 . '</td>
...
<fieldset>
  ...
  <p ALIGN="justify">' . $row->recomendaciones . '</p> &nbsp;
...
<div class="divTableRow">
<div class="divTableCell"><center>Nombre</center></div>
<div class="divTableCell"><center>Firma</center></div>
