...
<<<<<<< HEAD
 <input id="codigo_cuchilla" type="hidden" class="form-control input-sm"  name="codigo_cuchilla" value="<?= $data->codigo_cuchilla ?>">
                        <input id="cantidad_cuchilla" type="hidden" class="form-control input-sm"  name="cantidad_cuchilla" value="<?= $data->cantidad_cuchilla ?>">
                        <input id="precio_cuchilla" type="hidden" class="form-control input-sm"  name="precio_cuchilla" value="<?= $data->precio_cuchilla ?>">
                        <input id="codigo_cubierta" type="hidden" class="form-control input-sm"  name="codigo_cubierta" value="<?= $data->codigo_cubierta ?>">
                        <input id="cantidad_cubierta" type="hidden" class="form-control input-sm"  name="cantidad_cubierta" value="<?= $data->cantidad_cubierta ?>">
                        <input id="precio_cubierta" type="hidden" class="form-control input-sm"  name="precio_cubierta" value="<?= $data->precio_cubierta ?>">
                        <input id="codigo_llanta" type="hidden" class="form-control input-sm"  name="codigo_llanta" value="<?= $data->codigo_llanta ?>">
                        <input id="precio_llanta" type="hidden" class="form-control input-sm"  name="precio_llanta" value="<?= $data->precio_llanta ?>">
                        <input id="codigo_rasqueta" type="hidden" class="form-control input-sm"  name="codigo_rasqueta" value="<?= $data->codigo_rasqueta ?>">
                        <input id="cantidad_rasqueta" type="hidden" class="form-control input-sm"  name="cantidad_rasqueta" value="<?= $data->cantidad_rasqueta ?>">
                        <input id="precio_rasqueta" type="hidden" class="form-control input-sm"  name="precio_rasqueta" value="<?= $data->precio_rasqueta ?>">
                        <input id="codigo_inserto" type="hidden" class="form-control input-sm"  name="codigo_inserto" value="<?= $data->codigo_inserto ?>">
                        <input id="cantidad_inserto" type="hidden" class="form-control input-sm"  name="cantidad_inserto" value="<?= $data->cantidad_inserto ?>" >
                        <input id="precio_inserto" type="hidden" class="form-control input-sm"  name="precio_inserto" value="<?= $data->precio_inserto ?>">

                        <input id="codigo_inserto_2" type="hidden" class="form-control input-sm"  name="codigo_inserto_2" value="<?= $data->codigo_inserto_2 ?>">
                        <input id="cantidad_inserto_2" type="hidden" class="form-control input-sm"  name="cantidad_inserto_2" value="<?= $data->cantidad_inserto_2 ?>" >
                        <input id="precio_inserto_2" type="hidden" class="form-control input-sm"  name="precio_inserto_2" value="<?= $data->precio_inserto_2 ?>">

                         <input id="codigo_inserto_3" type="hidden" class="form-control input-sm"  name="codigo_inserto_3" value="<?= $data->codigo_inserto_3 ?>">
                        <input id="cantidad_inserto_3" type="hidden" class="form-control input-sm"  name="cantidad_inserto_3" value="<?= $data->cantidad_inserto_3 ?>" >
                        <input id="precio_inserto_3" type="hidden" class="form-control input-sm"  name="precio_inserto_3" value="<?= $data->precio_inserto_3 ?>">

                       
                        <input id="codigo_inserto_4" type="hidden" class="form-control input-sm"  name="codigo_inserto_4" value="<?= $data->codigo_inserto_4 ?>">
                        <input id="cantidad_inserto_4" type="hidden" class="form-control input-sm"  name="cantidad_inserto_4" value="<?= $data->cantidad_inserto_4 ?>" >
                        <input id="precio_inserto_4" type="hidden" class="form-control input-sm"  name="precio_inserto_4" value="<?= $data->precio_inserto_4 ?>">
                        
                        <input id="codigo_cuchilla_2" type="hidden" class="form-control input-sm"  name="codigo_cuchilla_2" value="<?= $data->codigo_cuchilla_2 ?>">
                        <input id="cantidad_cuchilla_2" type="hidden" class="form-control input-sm"  name="cantidad_cuchilla_2" value="<?= $data->cantidad_cuchilla_2 ?>">
                        <input id="precio_cuchilla_2" type="hidden" class="form-control input-sm"  name="precio_cuchilla_2" value="<?= $data->precio_cuchilla_2 ?>">
                        
                        <input id="codigo_cuchilla_3" type="hidden" class="form-control input-sm"  name="codigo_cuchilla_3" value="<?= $data->codigo_cuchilla_3 ?>">
                        <input id="cantidad_cuchilla_3" type="hidden" class="form-control input-sm"  name="cantidad_cuchilla_3" value="<?= $data->cantidad_cuchilla_3 ?>">
                        <input id="precio_cuchilla_3" type="hidden" class="form-control input-sm"  name="precio_cuchilla_3" value="<?= $data->precio_cuchilla_3 ?>">
                        
                        
                        <input id="codigo_cuchilla_4" type="hidden" class="form-control input-sm"  name="codigo_cuchilla_4" value="<?= $data->codigo_cuchilla_4 ?>">
                        <input id="cantidad_cuchilla_4" type="hidden" class="form-control input-sm"  name="cantidad_cuchilla_4" value="<?= $data->cantidad_cuchilla_4 ?>">
                        <input id="precio_cuchilla_4" type="hidden" class="form-control input-sm"  name="precio_cuchilla_4" value="<?= $data->precio_cuchilla_4 ?>">
                        
                        
                        <input id="codigo_cuchilla_5" type="hidden" class="form-control input-sm"  name="codigo_cuchilla_5" value="<?= $data->codigo_cuchilla_5 ?>">
                        <input id="cantidad_cuchilla_5" type="hidden" class="form-control input-sm"  name="cantidad_cuchilla_5" value="<?= $data->cantidad_cuchilla_5 ?>">
                        <input id="precio_cuchilla_5" type="hidden" class="form-control input-sm"  name="precio_cuchilla_5" value="<?= $data->precio_cuchilla_5 ?>">
                        
                        
                        <input id="codigo_cuchilla_6" type="hidden" class="form-control input-sm"  name="codigo_cuchilla_6" value="<?= $data->codigo_cuchilla_6 ?>">
                        <input id="cantidad_cuchilla_6" type="hidden" class="form-control input-sm"  name="cantidad_cuchilla_6" value="<?= $data->cantidad_cuchilla_6 ?>">
                        <input id="precio_cuchilla_6" type="hidden" class="form-control input-sm"  name="precio_cuchilla_6" value="<?= $data->precio_cuchilla_6 ?>">
                        
                        
                        <input id="codigo_cuchilla_7" type="hidden" class="form-control input-sm"  name="codigo_cuchilla_7" value="<?= $data->codigo_cuchilla_7 ?>">
                        <input id="cantidad_cuchilla_7" type="hidden" class="form-control input-sm"  name="cantidad_cuchilla_7" value="<?= $data->cantidad_cuchilla_7 ?>">
                        <input id="precio_cuchilla_7" type="hidden" class="form-control input-sm"  name="precio_cuchilla_7" value="<?= $data->precio_cuchilla_7 ?>">
                        
                        
                        <input id="codigo_cuchilla_8" type="hidden" class="form-control input-sm"  name="codigo_cuchilla_8" value="<?= $data->codigo_cuchilla_8 ?>">
                        <input id="cantidad_cuchilla_8" type="hidden" class="form-control input-sm"  name="cantidad_cuchilla_8" value="<?= $data->cantidad_cuchilla_8?>">
                        <input id="precio_cuchilla_8" type="hidden" class="form-control input-sm"  name="precio_cuchilla_8" value="<?= $data->precio_cuchilla_8 ?>">
                        
                        
                        <input id="codigo_cuchilla_9" type="hidden" class="form-control input-sm"  name="codigo_cuchilla_9" value="<?= $data->codigo_cuchilla_9 ?>">
                        <input id="cantidad_cuchilla_9" type="hidden" class="form-control input-sm"  name="cantidad_cuchilla_9" value="<?= $data->cantidad_cuchilla_9 ?>">
                        <input id="precio_cuchilla_9" type="hidden" class="form-control input-sm"  name="precio_cuchilla_9" value="<?= $data->precio_cuchilla_9 ?>">
                        
                        
                        <input id="codigo_cuchilla_10" type="hidden" class="form-control input-sm"  name="codigo_cuchilla_10" value="<?= $data->codigo_cuchilla_10 ?>">
                        <input id="cantidad_cuchilla_10" type="hidden" class="form-control input-sm"  name="cantidad_cuchilla_10" value="<?= $data->cantidad_cuchilla_10 ?>">
                        <input id="precio_cuchilla_10" type="hidden" class="form-control input-sm"  name="precio_cuchilla_10" value="<?= $data->precio_cuchilla_10 ?>">
                        
                        
                        <input id="codigo_cuchilla_11" type="hidden" class="form-control input-sm"  name="codigo_cuchilla_11" value="<?= $data->codigo_cuchilla_11 ?>">
                        <input id="cantidad_cuchilla_11" type="hidden" class="form-control input-sm"  name="cantidad_cuchilla_11" value="<?= $data->cantidad_cuchilla_11 ?>">
                        <input id="precio_cuchilla_11" type="hidden" class="form-control input-sm"  name="precio_cuchilla_11" value="<?= $data->precio_cuchilla_11 ?>">
