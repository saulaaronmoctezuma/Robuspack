...
<div     id="proveedor">
    <div class="container" >      
        ...
        <h3><MARQUEE HEIGHT=35 SCROLLDELAY =200>Agregando los datos de Control SIC TEST</MARQUEE></h3>
                                ...
                                <div class="form-group col-xs-4">
                                   ...
                                   <!-- <input id="a6" type="text" class="form-control input-sm"  name="marca_maquina" placeholder="Ingresa la marca " required>-->
                                    ...
                                    <select name="marca_maquina" id="marca_maquina" class="form-control input-sm" require>
                                        ...
                                        <OPTION VALUE="TAISHENG">TAISHENG</OPTION>
                                             
                                        <OPTION VALUE="HUALI">HUALI</OPTION>
                                        <OPTION VALUE="HEBEI">HEBEI</OPTION>
                                        <OPTION VALUE="ICM">ICM</OPTION>
                                        <OPTION VALUE="MACARBOX">MACARBOX</OPTION>
                                        <OPTION VALUE="DING LONG">DING LONG</OPTION>
                                                       
                                                       
                                        <OPTION VALUE="Hooper Swift">Hooper Swift</OPTION>
                                        <OPTION VALUE="GUANGZHOU HS">GUANGZHOU HS</OPTION>
                                        
                                        <OPTION VALUE="MARVI">MARVI</OPTION>
                                        <OPTION VALUE="TECASA">TECASA</OPTION>
                                        <OPTION VALUE="SAM MEX">SAM MEX</OPTION>
                                        
                                        
                                        <OPTION VALUE="GOPFERT">GOPFERT</OPTION>
                                    
                                         <OPTION VALUE="KINSDA">KINSDA</OPTION>
                                       
                                        <OPTION VALUE="UNIVERSAL">UNIVERSAL</OPTION>
                                        <OPTION VALUE="GUANGZHOU ">GUANGZHOU </OPTION>
                                        <OPTION VALUE="SYS-1224">SYS-1224</OPTION>
                                   ...
                                   <!--<input id="a6" type="text" class="form-control input-sm"  name="contacto" placeholder="Ingresa el modelo de maquina" required>-->
                                    <select name="contacto" class="form-control input-sm" require>
                                        <option  value="">Selecciona una opción</option>
                                           ...
                                           <OPTION VALUE="ZYK900 X 2000">ZYK900 X 2000</OPTION>
                                           <OPTION VALUE="6PA- FG">6PA- FG</OPTION>
                                         <OPTION VALUE="TECASA">TECASA</OPTION>
                                        ...
                                        <OPTION VALUE="BP">BP</OPTION> 
                                          ...
                                          <OPTION VALUE="50X110">50X110</OPTION>
                                            <OPTION VALUE="HKM-1600X2800">HKM-1600X2800</OPTION>
                                       
                                        <OPTION VALUE="AFPS EWS">AFPS EWS</OPTION>  
                                        <OPTION VALUE="LKYS">LKYS</OPTION>
                                           <OPTION VALUE="BPSD">BPSD</OPTION>  
                                            <OPTION VALUE="FFG 1300/2800">FFG 1300/2800</OPTION>
                                        <OPTION VALUE="PACK MACH">PACK MACH</OPTION>
                                        <OPTION VALUE="PACKPRINT 3 FG 1228">PACKPRINT 3 FG 1228</OPTION>
                                        
                                         <OPTION VALUE="EASY PRINT IV">EASY PRINT IV</OPTION> 
                                        <OPTION VALUE="GMFG">GMFG</OPTION> 
                                        <OPTION VALUE="KLPS">KLPS</OPTION> 
                                        <OPTION VALUE="GUANGZHOU HS">GUANGZHOU HS</OPTION> 
                                        <OPTION VALUE="CHAIN-FEED-FLEXO-1DP">CHAIN-FEED-FLEXO-1DP</OPTION> 
    ...
    <OPTION VALUE="TBC">TBC</OPTION>
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <select name="formato" class="form-control input-sm" requireD>
                                        ...
                                        <OPTION VALUE="1200 X 2800">1200 X 2800</OPTION>
                                        
                                        <OPTION VALUE="1626">1626</OPTION>
                                        <OPTION VALUE="1225">1225</OPTION>
                                        
                                        <OPTION VALUE="2/2800">2/2800</OPTION>
                                        <OPTION VALUE="35x78 1/2">35x78 1/2</OPTION>
                                        <OPTION VALUE="1200X2200">1200X2200</OPTION>
                                         <OPTION VALUE="1800X3600">1800X3600</OPTION>
                             ...
                             <div class="row">
                                ...
                                <div class="form-group col-xs-4">
                                    ...
                                    <select name="ancho" class="form-control input-sm" requireD>
                                        ...
                                        <OPTION VALUE="2100 mm">2100 mm</OPTION>
                                        ...
                                        <OPTION VALUE="2600 mm">2600 mm</OPTION>
                                        <OPTION VALUE="2800 mm">2800 mm</OPTION>
                                        <OPTION VALUE="2900 mm">2900 mm</OPTION>
                                       
                                        <OPTION VALUE="3000 mm">3000 mm</OPTION>
                                         <OPTION VALUE="3100 mm">3100 mm</OPTION>
                                          <OPTION VALUE="3200 mm">3200 mm</OPTION>
