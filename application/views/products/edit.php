                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="precio_de_compra" onkeyup="PrecioEnAlmacen();Precio1();Precio2();Precio3();" onkeypress="return filterFloat(event,this);" onchange="PrecioEnAlmacen();Precio1();Precio2();Precio3();" name="precio_de_compra" placeholderr="precio_de_compra" value="<?php echo $product_data['precio_de_compra']; ?>" autocomplete="off" />
                            </div>
                            
                            
                             <div class="form-group">
                                 <!-- <label for="valor_almacen">Valor Almacén</label>
                                <input type="text" class="form-control" id="valor_almacen" name="valor_almacen" placeholderr="valor_almacen" readonly style="background-color:#03E7F7;" title="Campo Autocompletable" value="<?php echo $product_data['valor_almacen']; ?>" autocomplete="off" />
                            </div>
...
-->
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <input type="text" onclick="fechaValidaActualizacionPrecio()" onkeyup="fechaValidaActualizacionPrecio()" style="background-color:#03E7F7;" title="Campo Autocompletable"  class="form-control" id="price4" name="price4" placeholderr="Escribe el precio 4" value="<?php echo $product_data['price4']; ?>" autocomplete="off" />
                            </div>
