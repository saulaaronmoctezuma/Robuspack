...
<<<<<<< HEAD
                                   ...
                                   <div class="form-group col-xs-6">
                                    ...
                                    <input type="text" class="form-control" id="refacciones_consumibles" name="refacciones_consumibles" placeholder="" autocomplete="off" />
   ...
   <div class="row">
                                <div class="form-group col-xs-6">
                                    ...
                                    <input type="text" class="form-control" onkeyup="PrecioEnAlmacen();" onChange="PrecioEnAlmacen();" id="qty" value="0" name="qty" placeholder="Escribe el Existencias" autocomplete="off" />
                                </div>
...
<<<<<<< HEAD
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-xs-6">
                                    ...
                                    <input type="text" class="form-control" onkeyup="fechaValidaActualizacionPrecio()" onclick="fechaValidaActualizacionPrecio()" id="price2" name="price2" style="background-color:#03E7F7;" title="Campo Autocompletable" placeholder="Escribe el Precio de Venta 2" autocomplete="off" />
                                </div>
                                ...
                                <div class="form-group col-xs-6">
                                    ...
                                    <input type="text" class="form-control" onkeyup="fechaValidaActualizacionPrecio()" onclick="fechaValidaActualizacionPrecio()" id="price3" name="price3" style="background-color:#03E7F7;" title="Campo Autocompletable" placeholder="Escribe el Precio de Venta 3" autocomplete="off" />
                           </div>
                            </div><br>
                                ...
                                <input type="text" class="form-control" onkeyup="fechaValidaActualizacionPrecio()" onclick="fechaValidaActualizacionPrecio()" id="price4" name="price4" placeholder="Escribe el Precio de Venta 4" autocomplete="off" />
                                     </div>
