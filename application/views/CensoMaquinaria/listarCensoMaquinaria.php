...
-->
 ...
 <div class="form-group col-xs-4">
                <form method="post" action="<?php echo base_url(); ?>ExportarExcel/crearExcelReporteCensoMaquinas">

                    <button  class="btn btn-info" title="Da clic para exportar los datos a Excel" style="font-size:16px;color:white"><font color="white">REPORTE MAQUINARIA</font> <i class="fa fa-file-excel-o"></i></button>
                </form> 
                  </div> 
                <?php
