    ...
    <body>
        ...
        <div class="container" style="margin-top:1px;">
            ...
            <div class="form-group input-group">
                ...
                <input  onkeyup="eliminarStyle()" type="text" id="myInput"  placeholder="Escribe para buscar..."  class="form-control" />
            ...
            <div class="form-group col-xs-4">
               <td><a  class="btn btn-success" href="<?php echo base_url(); ?>CensoMaquinaria/agregarProspectos"     data-toggle="tooltip" data-placement="right" title="Dar Clic para Guardar los Datos del Seguimiento">Agregar Nuevo Registro <i class="fa fa-plus" aria-hidden="true"></i></a></td>
              </div>
                ...
                ?> 
            <div class="form-group col-xs-4">
               <td><a  class="btn btn-success" href="<?php echo base_url(); ?>CensoMaquinaria/agregarProspectos"     data-toggle="tooltip" data-placement="right" title="Dar Clic para Guardar los Datos del Seguimiento">Agregar Nuevo Registro</a></td>
              </div>
            ...
            <div class="form-group col-xs-4">
                ...
                <form method="post" action="<?php echo base_url(); ?>ExportarExcel/crearExcelCensoMaquinariaProspectos">
            ...
            <div class="form-group col-xs-4">
               <form method="post" action="<?php echo base_url(); ?>ExportarExcel/crearExcelReporteCensoMaquinasProspectos">

                    <button  class="btn btn-info" title="Da clic para exportar los datos a Excel" style="font-size:16px;color:white"><font color="white">Reporte SIM</font> <i class="fa fa-file-excel-o"></i></button>
                </form>   
            </div> 
 ...
 $(".borrarStyle").removeAttr("style");
                ...
                <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script>
                 ...
                 <style type="text/css">
                        ...
                        <table id="1"  border="0" class="table table-bordered table-striped">
                    ...
                    <tr  >
                       ...
                       <?php
                        ...
                        <th class="info_maquina_1" >Info flexo 1</th>
                        <th class="info_maquina_2" style="display: none;">Info flexo 2</th>
                        <th class="info_maquina_3" style="display: none;">Info flexo 3</th>
                        <th class="info_maquina_4" style="display: none;">Info flexo 4</th>
                        <th class="info_maquina_5" style="display: none;">Info flexo 5</th>
...
//                   . '<td class="empresa" style="display: none;">' . $obj->getEmpresa() . '</td>';-->
                                        ...
                                        <div class="modal-header">
                                            <center>        
                                                <a title="Da clic para regresar" style="color:#000000" href="<?php echo site_url(); ?>CensoMaquinaria">    
                                                    <button type="button"  onclick="myFunction();" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                </a></center>

                                            <h4 class="modal-title" id="modalNecesidad">Empresa :  <?php echo $obj->getEmpresa() ?> <?php echo $obj->getEmpresa_temporal() ?>  
                                                <br> Grupo :  <?php echo $obj->getGrupo().$obj->getGrupo_temporal()  ?> </h4>
                                        </div>
    ...
    if ($dataLevel == 'is_admin') {
        ...
        echo '<td><a title="Da clic para modificar el registro" href="' . base_url() . 'CensoMaquinaria/actualizarProspecto/' . $obj->getId_censomaquinaria() . '"><button type="button" class="btn btn-warning btn-xs"><span class="glyphicon glyphicon-edit"></button></a></td>';
   //          echo '<td><a title="Da clic para modificar el registro" href="' . base_url() . 'CensoMaquinaria/actualizarFlexo/' . $obj->getId_censomaquinaria() . '"><button type="button" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-edit"></button></a></td>';
        ...
        echo '<td><a title="Da clic para modificar el registro" href="' . base_url() . 'CensoMaquinaria/actualizarProspecto/' . $obj->getId_censomaquinaria() . '"><button type="button" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></button></a></td>';
    } else if ($dataLevel == 'is_Gerente_Ventas') {
        echo '<td><a title="Da clic para modificar el registro" href="' . base_url() . 'CensoMaquinaria/actualizarProspecto/' . $obj->getId_censomaquinaria() . '"><button type="button" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></button></a></td>';
