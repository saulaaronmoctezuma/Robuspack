                ...
                <thead >
                    <tr >
                        ...
                        if ($dataLevel == 'is_admin') {
                            echo '<th class="header">Usuario</th>';
                            echo '<th class="header" style="text-align: center">Fecha De_Inserción</th>';
                            ...
                            echo '<th class="header" colspan="2" >Modificar</th>';
                        } else if ($dataLevel == 'is_Gerente_Ventas') {

                            echo '<th class="header">Fecha De Inserción</th>';
                            echo '<th class="header">Fecha de Modificación</th>';
                                echo '<th style="text-align: center">Observación</th>';
