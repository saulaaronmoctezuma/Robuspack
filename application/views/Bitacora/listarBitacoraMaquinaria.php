                ...
                <tbody align="center">
                    ...
                    foreach ($bitacora as $obj) {
                        ...
                        if ($dataLevel == 'is_admin') {
                            ...
                            echo '<td><a title="Da clic para modificar el registro" href="' . base_url() . 'Bitacora/obtener/' . $obj->getId_bitacora() . '"><button type="button" class="btn btn-warning"><span class="glyphicon glyphicon-comment"></button></a></td>';
                        } else if ($dataLevel == 'is_editor') {
