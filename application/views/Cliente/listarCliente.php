...
=======
                ...
                $query = $this->db->query('SELECT grupo FROM cliente');
                
    echo '<br><br><br><br><br><br><table border="1"><tr>';            
foreach ($query->result() as $row) 
{ 

echo '<th>'. $row->grupo.'    &nbsp;&nbsp;' . '</th>';
...
<<<<<<< HEAD
  ...
  <body>
  	 <div class="container" style="margin-top:1px;">
            ...
            <center>  <h1> Clientes Makbox</h1></center>
...
>>>>>>> 3ca633ddf977474f5162ba742b7bbb723f11e606
          <?php
            if ($dataLevel == 'is_Gerente_Ventas') {
                ...
                echo '  <center>
                                <a href="' . base_url() . 'ExportarExcel/crearExcelCliente/' . '">
                                <button  class="btn btn-info" title="Da clic para exportar los datos a Excel" style="font-size:16px;color:white"><font color="white">Exportar</font> <i class="fa fa-file-excel-o"></i></button>
                                 </a>
                        </center>';
            }
...
<<<<<<< HEAD
                    ...
                    if ($dataLevel == 'is_admin') {
                       ...
                       echo '<td colspan="2"><a title="Da clic para modificar el registro" href="' . base_url() . 'Cliente/obtener/' . $obj->getId_Cliente() . '"><button type="button" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></button></a></td>';
                    }
