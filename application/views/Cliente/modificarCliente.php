...
<div id="maquinaria">
    <form action="<?= base_url('Cliente/clienteModificar') ?>" method="post" align="center" onsubmit="return vali()">
        ...
        <div class="container" >
            <table class="table table-bordered table-striped">
                <tbody>
                    <tr>
                        <td><input class="form-control input-sm" type="hidden" name="id_cliente" value="<?= $id_cliente ?>"></td>
                    </tr>
                    <tr>
                        <td>Grupo</td>
                     ...
                     <td>
                         <SELECT name="moneda" class="form-control input-sm"> 
                            <optgroup label="Selecciona una opción">
                                ...
                                <option value="Ambos" <?php if ($moneda == "Ambos") {  echo "Selected";} ?>>Ambos</option>
                            </optgroup>
                          </SELECT>
                    </td>
                </tr>
            ...
            <td>
                         <SELECT name="vendedor_refacciones" class="form-control input-sm"> 
                                 ...
                                 <option  value="" <?php if ($vendedor_refacciones == "") {echo "Selected"; } ?>>Selecciona una opción</option>
                                 ...
                                 <option value="Elvira Parreño Arango" <?php if ($vendedor_refacciones == "Elvira Parreño Arango") {echo "Selected"; } ?>>Elvira Parreño Arango</option>
                                 <option value="Ilse Alejandra Bazaldua Zúñiga" <?php if ($vendedor_refacciones == "Ilse Alejandra Bazaldua Zúñiga") {echo "Selected"; } ?>>Ilse Alejandra Bazaldua Zúñiga</option>
                                 <option value="Karen Orlene Hernández Villagrán" <?php if ($vendedor_refacciones == "Karen Orlene Hernández Villagrán") {echo "Selected"; } ?>>Karen Orlene Hernández Villagrán</option>
                                 <option value="César Alberto Cantú Omaña" <?php if ($vendedor_refacciones == "César Alberto Cantú Omaña") {echo "Selected"; } ?>>César Alberto Cantú Omaña</option>
                                 <option value="Josué Aldo Guillén Ortega" <?php if ($vendedor_refacciones == "Josué Aldo Guillén Ortega") {echo "Selected"; } ?>>Josué Aldo Guillén Ortega</option>
            ...
            <td>
                         <SELECT name="vendedor_maquinaria" class="form-control input-sm"> 
                              ...
                              <option value="" <?php if ($vendedor_maquinaria == "") {echo "Selected"; } ?>>Selecciona una opción</option>
                                 
                                <option value="Sergio Peñafiel Soto" <?php if ($vendedor_maquinaria == "Sergio Peñafiel Soto") {echo "Selected"; } ?>>Sergio Peñafiel Soto</option>
                                 <option value="Gerardo López Martínez" <?php if ($vendedor_maquinaria == "Gerardo López Martínez") {echo "Selected"; } ?>>Gerardo López Martínez</option>
                                 <option value="Benjamín López Gamboa" <?php if ($vendedor_maquinaria == "Benjamín López Gamboa") {echo "Selected"; } ?>>Benjamín López Gamboa</option>
                                 <option value="Alejandra de Jesús Maldonado Martínez" <?php if ($vendedor_maquinaria == "Alejandra de Jesús Maldonado Martínez") {echo "Selected"; } ?>>Alejandra de Jesús Maldonado Martínez</option>
            ...
            <tr>
             ...
             <tr>
                        ...
                        <td>
                              ...
                              <option value="" <?php if ($metodo_pago == "") {echo "Selected"; } ?>>Selecciona una opción</option>
                                 
                                <option value="PUE Pago en una sola exhibición" <?php if ($metodo_pago == "PUE Pago en una sola exhibición") {echo "Selected"; } ?>>PUE Pago en una sola exhibición</option>
                                 <option value="PPD Pago en parcialidades o diferido" <?php if ($metodo_pago == "PPD Pago en parcialidades o diferido") {echo "Selected"; } ?>>PPD Pago en parcialidades o diferido</option>
   ...
   if ($uso_de_cfdi == "D09 Depósitos en cuentas para el ahorro, primas que tengan como base planes de pensiones") {
    echo "Selected";}?>>D09 Depósitos en cuentas para el ahorro, primas que tengan como base planes de pensiones</option>
   
   
                                        <option value="D10 Pagos por servicios educativos (colegiaturas)" <?php
 if ($uso_de_cfdi == "D10 Pagos por servicios educativos (colegiaturas)") { echo "Selected"; }
