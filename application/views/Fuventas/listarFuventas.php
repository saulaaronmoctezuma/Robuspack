...
<html lang="es-mx">
    ...
    <div class="container">
        <center>  <h1> Fu V Refacciones</h1></center>
    ...
    if ($dataLevel == 'is_admin') {
        ...
        <a class="btn btn-success" href="' . base_url('Fuventas/agregar') . '" data-toggle="tooltip" data-placement="right" title="Dar Clic para Guardar los Datos">Agregar Nuevo Registro</a>
    ...
    <div class="row">
        <div class="text-center">
            ...
            <form method="post" action="<?php echo base_url(); ?>ExportarExcel/crearExcelFuventas">
...
<<<<<<< HEAD
                    ...
                    '</td>';*/
                      ...
                      if ($obj->getFacturapdf() != null) {
                        echo '<td class="static" scope="th"><a  title="Da clic para descargar el archivo" href="' . base_url() . 'assets/fuventas/' . $obj->getFacturapdf() . '" target=”_blank” rel=”nofollow”><font color="black">' . $obj->getRef() . '  <i  title="Da clic para visualizar la factura" class="fa fa-check-circle" style="font-size:18px;color:green" aria-hidden="true"></i></font></a></td>';
                    } else {
                        echo '<td>'
                        . $obj->getRef() .
                        '  <i class="fa fa-times-circle-o" style="font-size:18px;color:red" title="No tiene factura agregada" aria-hidden="true"></i></td>';
                    }
...
<<<<<<< HEAD
                    ...
                    '</td>'; 
                         ...
                         if ($obj->getDescuento_mxn() > 0) {
                        echo '<td>'
                        . $obj->getDescuento_mxn() .
                        '%</td>';
                    } else  {
                        echo '<td>'
                        . $obj->getDescuento_mxn() .
