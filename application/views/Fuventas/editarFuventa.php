                    ...
                    ?>
                        ...
                        <td> <SELECT name="tipo_de_precio" class="form-control " > 
                            ...
                            <tr>
                                ...
                                <td>
                                    <input onkeyup="precioMxn();calcularTotalMxn();calcularSubtotalMxn();calcularIvaMxn();" onkeypress="return filterFloat(event,this);" id="tipo_de_cambio" class="form-control" type="text" name="tipo_de_cambio" value="<?= $data->tipo_de_cambio ?>">
                               </td>
                            </tr>


                            <tr>
                                <td><b>Precio en mn </b></td>
                                <td >
                                    <input style="background-color:#03E7F7;" readonly  title="PU USD * Tipo de cambio (TC)" onkeyup="calcularSubtotalMxn();" class="form-control input-sm" id="precio_mxn" type="text" name="precio_mxn" value="<?= $data->precio_mxn ?>">
                              </td>
                            </tr>


                            <tr>
                                <td><b>Descuento en mn </b></td>
                                <td >
                                   <input id="descuento_mxn" title="% del descuento en %" value="0" onkeyup="calcularSubtotalMxn();calcularIvaMxn();calcularTotalMxn()" oninput="if(parseFloat(this.value)>100){ this.value =100; return false; }" type="text" min="0" max="100" minlength="4" maxlength="7" onkeypress="return filterFloatDescuento(event,this);" class="form-control" type="text" name="descuento_mxn" value="<?= $data->descuento_mxn ?>">
                                  
                                </td>
                            </tr>
                            
                             <tr>
                                <td><b>Subtotal en mn </b></td>
                                <td >
                                   <input  title="(Precio en m.n(PU MN) * Cantidad) * (Descuento en % )  "  onkeyup="calcularTotalMxn()" type="text" id="subtotal_mxn"  style="background-color:#03E7F7;" readonly class="form-control" type="text" name="subtotal_mxn" value="<?= $data->subtotal_mxn ?>">
                                ...
                                <td><b>Iva en mn</b></td>
                                <td >
                                   <input id="iva_mxn" title="Subtotal en Mn * 16%" onkeyup="calcularTotalMxn()"  style="background-color:#03E7F7;" readonly class="form-control" type="text" name="iva_mxn" value="<?= $data->iva_mxn ?>">
                                  
                                </td>
                            </tr>
                            
                                 <tr>
                                <td><b>Total en mn</b></td>
                                <td >
                                   <input id="total_mxn" style="background-color:#03E7F7;"  title="Subtotal en Mn + Iva en Mn" readonly class="form-control" type="text" name="total_mxn" value="<?= $data->total_mxn ?>">
