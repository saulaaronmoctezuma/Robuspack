                           ...
                           <!--  <tr>
                            ...
                            <tr>
                                ...
                                <td> <SELECT name="tipo_de_prod" class="form-control " > 
                                        ...
                                        <option value="" <?php if ($data->tipo_de_prod == "") {
            echo "Selected";
        } ?>>Selecciona una opción</option>

                                        <option value="REFACCION" <?php if ($data->tipo_de_prod == "REFACCION") {
            echo "Selected";
        } ?>>REFACCION</option>
                                        <option value="CUBIERTA" <?php if ($data->tipo_de_prod == "CUBIERTA") {
            echo "Selected";
        } ?>>CUBIERTA</option>
                            ...
                            <tr>
                                ...
                                <td >
                                    <input id="cantidad" onkeyup="calcularSubtotal();
                                            ...
                                            calcularIva();
                                            calcularTotal();"   min="0" class="form-control" type="number" name="cantidad" value="<?= $data->cantidad ?>">
                            ...
                            <tr>
                                ...
                                <td >
                                    <input id="pu_usd" onkeyup="calcularSubtotal();
                                            ...
                                            calcularTotal();" onchange="calcularSubtotal();
                                            calcularIva();
                                            calcularTotal();"  class="form-control" min="0"  type="number" name="pu_usd" value="<?= $data->pu_usd ?>">
