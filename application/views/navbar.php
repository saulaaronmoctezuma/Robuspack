                   ...
                   <!-- <li><a href="<?php echo site_url(); ?>main/"><i class="glyphicon glyphicon-home" aria-hidden="true"></i> Inicio</a></li>-->
                              ...
                              <ul class="dropdown-menu">
                                   ...
                                   <li><a href="' . site_url() . '">Clientes</a></li>
                                    <li><a href="' . site_url() . '">Empresas</a></li>
                                      ...
                                      <li><a href="' . site_url() . '">Placas de Maquinaria</a></li>
                                      <li><a href="' . site_url() . '">Registro de Empresas</a></li>
                              </ul>
                            </li>
                    ...
                    if ($dataLevel_id == 1) {
                        ...
                        <?php
                         ...
                         ?>
                        <a href="<?php echo site_url(); ?>main/profile/">    <img class="circular--square" id="foto" src="<?php echo base_url(); ?>assets/fotos_perfil/sin_foto.png" height="45px"  width="45px" border="none" /> </a> 
                        <?php
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <!--<li><a href="<?php echo site_url(); ?>main/changeuser">Editar Perfil</a></li>  -->
                            ...
                            if ($dataLevel == 'is_admin') {
                               // echo '<script language="javascript">alert("Estamos actualizando el SIC");</script>'; 
                                echo '<li><a href="' . site_url() . 'main/changeuser">Editar Perfil</a></li>';
