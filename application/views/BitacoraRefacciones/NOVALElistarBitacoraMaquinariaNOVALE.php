                ...
                <thead >
                    <tr >
                        ...
                        if ($dataLevel == 'is_admin') {
                            ...
                            echo '<th class="header">Fecha De Inserción</th>';
                            echo '<th class="header">Fecha de Modificación</th>';
                            echo '<th class="header" colspan="2" >Retroalimentación</th>';
                ...
                <tbody align="center">
                    ...
                    foreach ($bitacora as $obj) {
                        ...
                        if ($dataLevel == 'is_admin') {
                            ...
                            echo '<td><a title="Da clic para modificar el registro" href="' . base_url() . 'BitacoraRefacciones/obtener1/' . $obj->getId_bitacora() . '"><button type="button" class="btn btn-comment"><span class="glyphicon glyphicon-comment"></button></a></td>';
                        } else if ($dataLevel == 'is_director') {
                            
                        } else {
                            echo '<td><a title="Da clic para modificar el registro" href="' . base_url() . 'BitacoraRefacciones/obtener/' . $obj->getId_bitacora() . '"><button type="button" class="btn btn-warning"><span class="glyphicon glyphicon-edit"></button></a></td>';
                        }
                    }
                    ?>
                    </tr    >
