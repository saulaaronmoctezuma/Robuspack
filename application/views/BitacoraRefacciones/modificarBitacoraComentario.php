    ...
    <form action="<?= base_url('Bitacora/bitacoraModificar') ?>" method="post" align="center" onsubmit="return vali()">
        ...
        <div class="container" >
            <table class="table table-bordered table-striped" >
                ...
                <td>Cliente</td>
               <td><input id="a2" readonly style="background-color:#03E7F7;" class="form-control" type="text" name="descripcion" value="<?= $cliente ?>"></td></tr>
                    <tr>
                    ...
                    <tr>
                        <td><input class="form-control" type="hidden" name="archivo1" value="<?= $archivo1 ?>"></td>
                    </tr>
                    <tr>
