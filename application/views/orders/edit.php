            ...
            <div class="col-md-12 col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Ver Orden</h3>
                    </div>
                    <!-- /.box-header -->
                    <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" style="background-color:#D1D1D1;;"  readonly class="form-control " id="bill_no" name="bill_no" placeholder="Escribe el numero de Factura" value="<?php echo $order_data['order']['bill_no'] ?>" autocomplete="off" />
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left; font-size: 15px;">Nombre del Cliente</label>
                                        <div>
                                            <input type="text" readonly class="form-control" style="background-color:#D1D1D1;" id="customer_name" name="customer_name" placeholder="Escribe el mombre del cliente" value="<?php echo $order_data['order']['nombre'] ?>" autocomplete="off"/>
                                        </div>   
...
<!--   <select id="a3" class="form-control input-sm" name="customer_name" <?php echo form_dropdown('clienteCombo', $clienteCombo, $order_data['order']['customer_name'], '#', 'id="customer_name"'); ?> </select> 
                           ...
                           <div class="col-sm-7">-->
                            <input type="hidden" class="form-control" id="customer_address" name="customer_address" placeholder="Enter Customer Address" value="<?php echo $order_data['order']['customer_address'] ?>" autocomplete="off">
                            <!--</div>
                      </div>-->
                        ...
                        <div class="col-sm-7">-->
                            <input type="hidden" class="form-control" id="customer_phone" name="customer_phone" placeholder="Enter Customer Phone" value="<?php echo $order_data['order']['customer_phone'] ?>" autocomplete="off">
                            <!--  </div>
                      </div>-->
                        </div>
                                    ...
                                    <?php if (isset($order_data['order_item'])) : ?>
                                        ...
                                        <?php foreach ($order_data['order_item'] as $key => $val) : ?>
                                            ...
                                            <tr id="row_<?php echo $x; ?>">
                                                <td>
                                                    <select class="form-control select_group product sinborde" disabled data-row-id="row_<?php echo $x; ?>" id="product_<?php echo $x; ?>" name="product[]" style="width:100%;" onchange="getProductData(<?php echo $x; ?>)" required>
                                                        <option value=""></option>
        ...
        <?php endforeach ?>
                                                ...
                                                <td><input readonly oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" min="1" max="5000" maxlength="4" type="number" name="qty[]" id="qty_<?php echo $x; ?>" class="form-control sinborde" onchange="getTotal(<?php echo $x; ?>)" onkeyup="getTotal(<?php echo $x; ?>)" value="<?php echo $val['qty'] ?>" autocomplete="off"></td>
                                                <td> 
                                                    <input type="text" name="rate[]" id="rate_<?php echo $x; ?>" class="form-control" disabled value="<?php echo $val['rate'] ?>" autocomplete="off">
                                                    Pedimento<input type="text" name="rate[]" id="rate_<?php echo $x; ?>" class="form-control" disabled value="<?php echo $val['pedimento'] ?>" autocomplete="off">
