...
//check user level
?>
<header class="main-header" style="background-color: #ec6c64">
    <!-- Logo -->
    <a href="<?php echo base_url('') ?>" class="logo" style="background-color: #ec6c64" >
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini" style="background-color: #ec6c64"><b>SCR</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg" style="background-color: #ec6c64"><b>SCROBUSPACK</b></span>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-inverse navbar navbar-static-top" style="background-color: #ec6c64">
...
//check user level
    ?>
    <header class="main-header" style="background-color: #1DDDFF">
        <!-- Logo  #ec6c64 -->
        <a href="<?php echo base_url('') ?>" class="logo" style="background-color: #1DDDFF">
            <!-- mini logo for sidebar mini 50x50 pixels -->
            <span class="logo-mini" style="background-color: #1DDDFF"><b>SCR</b></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg" style="background-color: #1DDDFF"><b>SCROBUSPACK</b></span>
        </a>


        <!-- Header Navbar: style can be found in header.less -->
        <nav class="navbar navbar-inverse navbar navbar-static-top" style="background-color: #1DDDFF">
            <!-- Sidebar toggle button-->
            <a href="#" class="sidebar-toggle" data-toggle="push-menu" role="button">
                <span class="sr-only">Toggle navigation</span>
            </a>
