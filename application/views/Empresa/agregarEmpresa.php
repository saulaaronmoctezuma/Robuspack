    ...
    <div class="container" >      
        ...
        <form name="formulario" id="formal" role="form" action="<?= base_url('Empresa/formularioAgregar') ?>" method="POST" onsubmit="return valida()">
            ...
            <div class="row">
                ...
                <div class="form-group col-xs-4">
                    <label>Estatus</label>
                    <select name="estatus" class="form-control input-sm" required>
                        <option  value="">Selecciona una opción</option>
                ...
                <div class="form-group col-xs-4">
                    ...
                    <select name="vendedor" class="form-control input-sm" required>
                        <option  value="">Selecciona una opción</option>
                ...
                <div class="form-group col-xs-4">
                    ...
                    <input id="a4" type="text" class="form-control"  name="nombre" placeholder="Ingresa el nombre de la empresa" >
                </div>
            </div>
            <br>
            ...
            <div class="row">
                ...
                <div class="form-group col-xs-4">
                    ...
                    <input id="a4" type="text" class="form-control"  name="email2" placeholder="Ingresa el correo de la empresa" >
                </div>
            </div>
            <br>
            <div class="row">
                ...
                <div class="form-group col-xs-4">
                    ...
                    <select name="marketing" class="form-control input-sm" required>
                        <option  value="">Selecciona una opción</option>
            ...
            <div class="row">
                ...
                <div class="form-group col-xs-4">
                    ...
                    <select name="integrados" class="form-control input-sm" required>
                        <option  value="">Selecciona una opción</option>
                ...
                <div class="form-group col-xs-4">
                    ...
                    <select name="corrugadora" class="form-control input-sm" required>
                        <option  value="">Selecciona una opción</option>
                        <OPTION VALUE="Sí">Sí</OPTION>
                        <OPTION VALUE="No">No</OPTION>
                ...
                <div class="form-group col-xs-4">
                    ...
                    <select name="sheet" class="form-control input-sm" required>
                        <option  value="">Selecciona una opción</option>
            ...
            <div class="row">
                ...
                <div class="form-group col-xs-4">
                    ...
                    <select name="single" class="form-control input-sm" required>
                        <option  value="">Selecciona una opción</option>
                        <OPTION VALUE="Sí">Sí</OPTION>
                        <OPTION VALUE="No">No</OPTION>
                        <
                ...
                <div class="form-group col-xs-4">
                    ...
                    <select name="comercializadora" class="form-control input-sm" required>
                        <option  value="">Selecciona una opción</option>
                        <OPTION VALUE="Sí">Sí</OPTION>
                        <OPTION VALUE="No">No</OPTION>
                        <
            ...
            <div class="row">
                <div class="form-group col-xs-4">
                    <label for="nombre">Flexos Actuales </label>
                    <input id="a4" type="text" class="form-control"  name="flexos" placeholder="Ingresa los flexos">
                </div>
                <div class="form-group col-xs-4">
                ...
                <!--<div class="form-group col-xs-4">
                    ...
                    <input id="a4" type="text" class="form-control"  name="comentarios" >
                </div>-->
                <div class="form-group col-xs-4">
                    <label for="nombre">Comentarios</label>
                    <textarea name="comentarios" class="form-control input-sm"  rows="5" cols="80" placeholder="Ingresa una observación"></textarea>
                </div>
            </div>
           ...
           <!--<div class="row">
                ...
                <div class="form-group col-xs-2">
                    <a title="Da clic para regresar al menú" href="../Empresa/" class="form-control btn btn-danger col-xs-4">Cancelar</a>-->
                </div> 
            </div> 
        </form>
    </div>
