...
<table class="table table-hover table-bordered table-striped" id="example" >
                ...
                foreach ($bitacora_mtto as $obj) {
                    ...
                    echo '<td> <br>    <a target="_blank" title="Descargar la ficha técnica en PDF" href="' . base_url() . 'Reporte/pdfBitacoraMantenimiento/' . $obj->getId_bitacora() . '"  ><center><i style="font-size:18px;color:red" class="fa fa-file-pdf-o"></i></center></a></td>
