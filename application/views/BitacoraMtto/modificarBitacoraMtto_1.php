...
$idUser= $this->session->userdata['id'];  
        ...
        if($idUser!=$data->id&& $dataLevel ==='is_mantenimiento'){
...
<?php
  ...
  <?php
            ...
            <div class="form-group">
             ...
             <a  title="Da clic para visualizar el archivo" href="' . base_url() . 'assets/bitacora_mtto/' . $data->foto . '" target=”_blank” rel=”nofollow”><br> Ya tienes un archivo cargado. <br>Si es necesario puedes actualizar la foto, para eso selecciona un nuevo archivo y guarda los cambios.</a><br>
