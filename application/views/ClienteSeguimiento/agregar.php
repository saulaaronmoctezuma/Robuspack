...
<<<<<<< HEAD
                        ...
                        <div class="row">
                            <div class="form-group col-xs-6">
                                <label for="nombre">Modelo Máquina </label>
                                <input id="modelo_maquina" type="text" class="form-control"  name="modelo_maquina" placeholder="Ingresa el nombre de la máquina">
                            </div>
