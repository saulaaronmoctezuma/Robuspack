...
=======
    <body>
        ...
        <div class="container" style="margin-top:1px;">
            ...
            <?php
            if ($dataLevel == 'is_admin') {
                echo '<center><a title="Da clic para agregar el registro" href="' . base_url() . 'Maquinaria/agregar/"><button type="button" class="btn btn-success">Agregar Nuevo Registro</button></a>
               <br>  <br>
                  <a title="Da clic para exportar los datos en Excel" href="' . base_url() . 'ExportarExcel/crearExcelConsumibles/">     <button  class="btn btn-info" title="Da clic para exportar los datos a Excel" style="font-size:15px;color:white"><font color="white">Exportar</font> <i class="fa fa-file-excel-o"></i></button>
                   </a></center>';
            } else if ($dataLevel == 'is_editor') {
                echo '<center><a title="Da clic para agregar el registro" href="' . base_url() . 'Maquinaria/agregar/"><button type="button" class="btn btn-success">Agregar Nuevo Registro</button></a>
               <br>  <br>
...
=======
                        ...
                        if ($dataLevel == 'is_admin') {
                            ...
                            echo '<th class="header">Stock</th><th class="header" style="text-align: center"  >Piezas a recibir</th>';
                        } else if ($dataLevel == 'is_editor') {
