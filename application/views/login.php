...
<body data-vide-bg="<?php echo base_url(); ?>assets/login/octubre2020.mp4">
   ...
   <div class="col-md-4">
    ...
    <div class="col-md-4 "></div>
    <div class="col-md-4 ">
        <img width="100%" style="float:right;" class="profile-img img-responsive logo" src="<?php echo base_url(); ?>assets/images/scr_negro.png" id="bgvid" playsinline autoplay muted loop>
    </div>
...
#contenido{
 ...
 <!--<div class="titulo_boton">
    ...
    <a style='cursor: pointer;' class="btn btn-success" onClick="muestra_oculta('contenido')" title="" class="boton_mostrar"><h1>Mostrar Formulario</h1></a>
</div>-->
...
=======
<div class="col-lg-4 " id="contenido1">
    <!--<div class="col-lg-4 col-lg-4">-->
