...
Class TotSic extends CI_Controller {
    ...
    public function index() {
        ...
        if ($dataLevel == "is_admin") {
            ...
            $data['totalRegistroSicOrlene'] = $this->TotSicModelo->totalRegistroSicOrlene(1);
            ...
            $data['totalRegistroSicNoTroquelaOrlene'] = $this->TotSicModelo->totalRegistroSicNoTroquelaOrlene(1);
            ...
            $data['totalRegistroSicConfirmacionOrlene'] = $this->TotSicModelo->totalRegistroSicConfirmacionOrlene(1);
            ...
            $data['totalRegistroSicOrdenOrlene'] = $this->TotSicModelo->totalRegistroSicOrdenOrlene(1);
            ...
            $data['totalRegistroSicSinPedidoOrlene'] = $this->TotSicModelo->totalRegistroSicSinPedidoOrlene(1);
